...
# if(graph == TRUE) {
#   total_fisheries_df_longer=pivot_longer(data=final_revenue_total_df, cols=X2:V5, names_to = "catch_locations", values_to = "revenue")
#   
#   revenue_graph=ggplot(data=total_fisheries_df_longer, aes(x=catch_locations, y=revenue)) +
#     geom_col()
# }
# 
