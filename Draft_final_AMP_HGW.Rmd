...
# Sum fish prices at each location (X1, X2, X3, X4, X5)
price_df1=data.frame(matrix(nrow=1, ncol=ncol(catch)))
for(i in 1:ncol(catch)){
  price_df1[i]=sum(price_df[,i])
} #trying to sum the prices for each column but not getting it to work...
```
