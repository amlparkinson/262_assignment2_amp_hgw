...
location_revenue(catch$catch_Naples)
...
catch_summary(catch) #works! but 'fish' is in () by function, but I dont use fish in the functin. is that an issue?
